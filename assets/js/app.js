...
function getProspectingHTML() {
  ...
  const tokenUsage = AppState.tokenUsage || { used: 0, limit: 0 }; 
    ...
    const defaultLimit = (tokenUsage && tokenUsage.limit > 0) ? Math.min(50, maxTokens) : 50;
    ...
    return `
        <div class="max-w-[1400px] mx-auto">
            <div id="search-token-limit-banner" class="hidden mb-6 p-4 bg-amber-50 border border-amber-200 rounded-2xl text-amber-800 text-sm font-medium flex items-center gap-2">
                ...
                <span>Você atingiu o limite de tokens do seu plano para este período. Cada de resultados nos cards (até 50 itens) consome 1 token. Solicite mais créditos em <strong>Solicitar Créditos</strong> no menu ou aguarde o próximo período.</span>
            </div>
...
function setupCnpjEvents() {
    ...
    form.onsubmit = async function(e) {
        ...
        // ... restante da lógica de busca do CNPJ ...
    };
} // <--- Certifique-se de que esta chave fecha a função setupCnpjEvents
// =============================================================================
