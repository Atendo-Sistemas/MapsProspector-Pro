                ...
                <nav class="sidebar-nav-scroll flex-grow min-h-0 overflow-y-auto p-6 flex flex-col gap-0">
                    ...
                    <div class="pb-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <button data-tab="choose-plan" id="nav-btn-choose-plan" class="tab-btn w-full flex items-center gap-4 px-5 py-4 rounded-2xl transition-all font-semibold text-sm hover:bg-slate-800/50 text-slate-400">
                    ...
                    <div id="nav-block-administracao" class="hidden">
                        ...
                        <div class="pt-2 pb-4">
                            ...
                            <div class="space-y-2">
                                <button data-tab="saas-config" id="tab-btn-saas-config" class="tab-btn w-full flex items-center gap-4 px-5 py-4 rounded-2xl transition-all font-semibold text-sm hover:bg-slate-800/50 text-slate-400">
